...
public class SMTPSClient extends SMTPClient {
     ...
     */
    public SMTPSClient() {
        this(DEFAULT_PROTOCOL, false, __DEFAULT_ENCODING);
    }
    ...
    public SMTPSClient(boolean implicit) {
        this(DEFAULT_PROTOCOL, implicit, __DEFAULT_ENCODING);
    }
    ...
    public SMTPSClient(String proto) {
        this(proto, false, __DEFAULT_ENCODING);
    }
     ...
     * @param proto the protocol.
     */
    public SMTPSClient(String proto, String encoding) {
        this(proto, false, encoding);
    }
     ...
     */
    public SMTPSClient(boolean implicit, SSLContext ctx, String encoding) {
        super(encoding);
        isImplicit = implicit;
        context = ctx;
    ...
    public SMTPSClient(SSLContext context) {
        this(false, context, __DEFAULT_ENCODING);
    }
